...
|---|---|---|
| Employment | −7.0% [−10.2, −3.6] (about 13.5 million jobs against the 194 million there would have been in 2040) | high |
| GDP | +5.3% | high |
| Real wages | +3.3% [+1.7, +6.1] | high |
| Wage share | −5.8 pp | high |

In levels: about 167 million jobs today (OEWS May 2025 base, including gig and freelance work), 194 million by 2040 without further AI progress, 180 million with it (likely 174 to 187 million), so more jobs than today and fewer than there would have been. Most of the gap is hiring that never happens: about 7.8 million positions are never offered to new entrants against 2.9 million layoffs, the layoff share fitted to the AI-cited job cuts employers announced in 2025 and the first half of 2026 (Challenger, Gray & Christmas). The range is the range of the model's assumptions: the macro closure is a structural axis, and the median is −6.2% with demand feedback on and −7.9% with it off; the 64 mechanism cells span −10.4% to −2.1% and agree on the sign. Phase 9b's real sector tables (OEWS May 2025, BEA 2024 use table) replaced the single-sector fixture: prices now respond to labour's share of gross output by sector and cost savings propagate through the input-output matrix, which together leave the headline close to Phase 9's while moving the wage share to −5.8 points. The backtest against 2024–2026 says adoption is within survey noise, the model's layoffs start a year early, revenue is within the fitted range, and a fit to 2025 alone under-predicts 2026. Robots and vehicles reach 5% of task-hours by 2040 at central assumptions. See `docs/findings-phase9b.md`.
...
AI Workforce Sim is built and maintained by [Saro Saravanan](https://saro-saravanan.github.io). The code, the scenario files and the documents are released under the [MIT License](LICENSE). The model produces scenarios, not forecasts, and nothing in it is advice; the [terms of use](docs/terms.md) (also at `/terms` in the app) carry the no-warranty and no-liability terms. Every source dataset keeps its own licence, listed in the [data inventory](docs/data-inventory.md).
