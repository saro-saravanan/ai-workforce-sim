...
4b. **The sector layer**: 20 NAICS sectors with the OEWS May 2025 occupation mix; labour's share of gross output (prices, demand), of value added (the reported productivity gain), the consumption shares and the direct-requirements matrix (input-output propagation of cost savings) come from the BEA 2024 summary use table; demand elasticities and adoption frictions are estimates.
