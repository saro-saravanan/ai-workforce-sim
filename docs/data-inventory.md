...
- **BEA input-output sector table** (review item 10): not obtained; bea.gov, bls.gov and FRED were unreachable from the build environment. Required before any sectoral claim.
