...
- AI revenue run rates (OpenAI ≈ $40bn annualized, July 2026; Anthropic ≈ $47bn gross, August 2026): press summaries only; the scoreboard row uses $85bn combined with a 70–100 range. Replace with audited figures or a consistent third-party estimate of the generative-AI market (the 2026 estimates in circulation run from about $90bn to about $200bn depending on scope).
