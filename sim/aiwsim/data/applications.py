...
FORECASTS: list[dict] = [
    ...
    {"source": "Reported annualized revenue run rates: OpenAI ~$40bn (Jul 2026), Anthropic ~$47bn gross (Aug 2026)", "short": "Frontier labs' revenue run rate, mid-2026", "region": "US", "year": 2026, "quarter": "2026Q2",
     "metric": "ai_producer_revenue_bn", "proxy": 1, "claimed": 85.0, "unit": "$bn/yr revenue run rate, OpenAI and Anthropic combined (reported range 70-100)",
     "note": "the two labs' run rates in mid-2026, before cloud, chip and integrator revenue; compared with the model's AI producers' revenue across every stage and region, which counts only what employers and consumers spend to replace or speed up work",
     "source_tag": "press summaries of reported run rates (V: page summaries 2026-09-03; company figures not audited)"},
